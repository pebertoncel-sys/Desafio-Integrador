...
public class MediaAcimaDe30 {
    public static void main(String[] args) {
        Scanner entrada = new Scanner(System.in);
        int quantidade = 0;
        int comprasAcimaDe30 = 0;
        double total = 0;
        double somaAcimaDe30 = 0;
        double maior = 0;
        double menor = 0;
        int continuar = 1;
        ...
        System.out.println("Compras acima de R$ 30,00: " + comprasAcimaDe30);
        if (comprasAcimaDe30 > 0) {
            System.out.printf("Media das compras acima de R$ 30,00: R$ %.2f%n", somaAcimaDe30 / comprasAcimaDe30);
        } else {
            System.out.println("Nao houve compras acima de R$ 30,00.");
        }
        entrada.close();
    }
}
